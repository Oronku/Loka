...
import QuicketPlaceSearch, { PlaceData } from '../components/QuicketPlaceSearch';
							...
							<Box sx={{ mt: 4 }}>
								...
								<List sx={{ maxHeight: 300, overflow: 'auto' }}>
									{checkIns.map((checkIn) => (
										<ListItem key={checkIn._id} alignItems="flex-start" sx={{ px: 0 }}>
											<ListItemAvatar>
												...
												secondary={
													<>
														...
														<Typography variant="caption" color="text.secondary">
															{new Date(checkIn.createdAt).toLocaleDateString()} {t('at')} {new Date(checkIn.createdAt).toLocaleTimeString()}
														</Typography>
													</>
												}
											/>
							...
							<Grid item xs={6} sm={4} md={2} key={city.name}>
								...
								>
									<CardActionArea onClick={() => handleCityClick(city)}>
										<CardMedia component="img" height="120" image={city.image} alt={city.name} />
