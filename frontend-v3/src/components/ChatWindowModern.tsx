    ...
    if (isLokaChat) {
      ...
      try {
        ...
        const apiUrl = import.meta.env.DEV 
          ? '/api/ai/message' 
          : (import.meta.env.VITE_API_URL || 'http://localhost:3001/api') + '/ai/message';
                          ...
                          >
                            ...
                            >
                              {msg.text.split('\n').map((line, idx, arr) => {
                                ...
                                if (hasTrips && (line.trim().startsWith('━━━') || line.trim().startsWith('✈️') || line.includes('**יעדים:**') || line.includes('**תאריכים:**') || line.includes('**משך:**') || line.includes('**סטטוס:**'))) {
                                  return null;
                                }
