...
export async function getBudget(tripId: string): Promise<Budget> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}`, {
...
export async function saveBudget(tripId: string, budget: Budget): Promise<Budget> {
...
export async function updateBudget(tripId: string, updates: Partial<Budget>): Promise<Budget> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}`, {
		method: 'PUT',
		headers: getAuthHeaders(),
...
export async function addBudgetCategory(tripId: string, category: Omit<BudgetCategory, 'id'>): Promise<BudgetCategory> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/categories`, {
		method: 'POST',
		headers: getAuthHeaders(),
...
export async function updateBudgetCategory(tripId: string, categoryId: string, updates: Partial<BudgetCategory>): Promise<BudgetCategory> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/categories/${categoryId}`, {
		method: 'PUT',
		headers: getAuthHeaders(),
		body: JSON.stringify(updates),
	});
...
export async function deleteBudgetCategory(tripId: string, categoryId: string): Promise<void> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/categories/${categoryId}`, {
		method: 'DELETE',
		headers: getAuthHeaders(),
	});
...
export async function getExpenses(tripId: string): Promise<Expense[]> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/expenses`, {
		method: 'GET',
		headers: getAuthHeaders(),
	});
...
export async function addExpense(tripId: string, expense: Expense): Promise<Expense> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/expenses`, {
		method: 'POST',
		headers: getAuthHeaders(),
...
export async function updateExpense(tripId: string, expenseId: string, updates: Partial<Expense>): Promise<Expense> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/expenses/${expenseId}`, {
		method: 'PUT',
		headers: getAuthHeaders(),
		body: JSON.stringify(updates),
	});
...
export async function cleanupAutoAddedExpenses(tripId: string): Promise<void> {
	const response = await fetch(`${API_BASE_URL}/budgets/${tripId}/expenses?cleanup=auto`, {
		method: 'DELETE',
		headers: getAuthHeaders(),
	});
